...
R0 = 0
E0, I0, R0 = 20000, 50, 0 # Initial number of infected, Exposed, Recovered individuals, I0 and R0.
...
def deriv(y, t, N, beta_0, alpha, gamma, m):
    S, E, I, R = y    
    beta = line(t, beta_0, m)
...
def calculate_confirmed_array(beta_t, alpha_t, gamma_t, theta_t, y0, m_t):
    ret = odeint(deriv, y0, t, args=(N, beta_t, alpha_t, gamma_t, m_t))
    S, E, I, R = ret.T
...
data_c = calculate_confirmed_array(beta, alpha, gamma, theta, y0, m)
print(data_c)
...
def calculate_error(x):
    ...
    model_data = calculate_confirmed_array(beta_t, alpha, gamma, theta, y0, m_t)
...
data_c2 = calculate_confirmed_array(nbeta, alpha, gamma, theta, ny0, nm)


nr_0 = nbeta/gamma
print("new r_0 =" + str(nr_0))

print("last r: " + str(line(37, nbeta, nm)/gamma))




rs = line(t, nbeta, nm)/gamma
#print(rs)
