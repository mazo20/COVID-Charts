...
R0 = 0
E0, I0, R0 = 0, 50, 0 # Initial number of infected, Exposed, Recovered individuals, I0 and R0.
...
treshold = 25 #untill which time point, can we extrapolate values
...
def calculate_error(x):
    ...
    model_data = calculate_confirmed_array(beta_t, alpha, gamma, theta, y0)
...
data_c2 = calculate_confirmed_array(nbeta, alpha, gamma, theta, ny0)
